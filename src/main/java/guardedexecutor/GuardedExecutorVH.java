...
public final class GuardedExecutorVH extends AbstractOwnableSynchronizer
    implements Executor, Serializable {

  /**
   * Constructs a new {@code GuardedExecutor}.
   */
  public GuardedExecutorVH() {}
  ...
  static {
    try {
      ...
      STATE = lookup.findVarHandle(GuardedExecutorVH.class, "state", int.class);
      TAIL = lookup.findVarHandle(GuardedExecutorVH.class, "tail", Node.class);
  ...
  static final class Node {
    ...
    static {
      try {
        MethodHandles.Lookup lookup = MethodHandles.lookup();
        STATUS = lookup.findVarHandle(Node.class, "status", int.class);
      } catch (ReflectiveOperationException e) {
        throw new ExceptionInInitializerError(e);
      }
    }
