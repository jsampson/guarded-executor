...
public final class BargingGuardedExecutor extends AbstractOwnableSynchronizer
    implements Executor, Serializable {

  /**
   * Constructs a new {@code BargingGuardedExecutor}.
   */
  public BargingGuardedExecutor() {}
  ...
  private static final AtomicIntegerFieldUpdater<BargingGuardedExecutor> STATE =
      AtomicIntegerFieldUpdater.newUpdater(BargingGuardedExecutor.class, "state");
  private static final AtomicReferenceFieldUpdater<BargingGuardedExecutor, Node> TAIL =
      AtomicReferenceFieldUpdater.newUpdater(BargingGuardedExecutor.class, Node.class, "tail");
